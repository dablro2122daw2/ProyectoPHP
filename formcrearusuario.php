...
<body>
    ...
    <input type="button" value="Usuari Client" onclick="location.href='formaltausuario.php'">
    <input type="button" value="Bibliotecari" onclick="location.href='formaltabibliotecario.php'">
